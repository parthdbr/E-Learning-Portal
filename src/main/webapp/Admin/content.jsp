		    ...
		    <div class="layout-wrapper layout-content-navbar">
      		<div class="layout-container">
     	    	<div class="content-wrapper">
              		...
              		<h4 class="fw-bold py-3 mb-4">Add a Content to Course</h4>
              		<div class="row">
              			<div class="col-md">
		                  <div class="card mb">
		                    <div class="card-body">
		                    	<form method="POST" id="courseAdmin" action="../contentAdmin" name="courseAdmin">
			                    	<div class="row mb-3">
			                          ...
			                          <div class="col-sm-10">
			                            <select id="course" class="form-control form-select" name="coursename">
				                          ...
				                          <%
											...
											%>	
												<option value="<%= id %>"><%= resultSet.getString("cname") %></option>																		
											<%
											}
											connection.close();
											} catch (Exception e) {
			                        ...
			                        <div class="row mb-3">
			                      	...
			                      	<div class="row mb-3">
			                        	<label for="stopic" class="col-sm-2 col-form-label">Sub Topic</label>
			                        	<div class="col-sm-10">
			                        		<input type="text" name="stopic" class="form-control" id="stopic"/>
			                        	</div>
			                        </div>
